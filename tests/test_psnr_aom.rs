...
/// SVT-AV1 エンコード → aom デコードのカラーバー PSNR 検証
...
// ============================================================================
// SVT-AV1 エンコード → aom デコード: ラウンドトリップテスト
// ============================================================================

/// SVT-AV1 VBR でダミーフレームのラウンドトリップ
#[test]
fn test_roundtrip_svt_av1_aom_dummy_frames() {
    let width = 320;
    let height = 240;
    let num_frames = 5;
...
// ============================================================================
// SVT-AV1 エンコード → aom デコード: PSNR テスト
// ============================================================================

/// SVT-AV1 VBR カラーバーの PSNR 検証
#[test]
fn test_psnr_svt_av1_aom_vbr() {
    let mut config =
